...
import styles from "./painful.module.scss";
...
import art from "Images/painful.jpg";

/* Glitch Effect 적용 */
const Painful = ({ history }) => {
    ...
    >
      ...
      <section className={styles["info"]}>
        ...
        <div className={styles["info__desc"]}>
          ...
          >
            나는 진짜 나일까? 기계 같고 이 세상 사람이 아닌 느낌이 들 때가 있다.
            <br />
            사람은 누구나 생각한다. 생각하지 못하는 사람은 세상에 존재할 수
            없다. <br />
            그러기에 지금 나는 살아있고 나 자신에서 벗어나지 않으려 노력하며
            살아야 한다.
          </div>
        </div>
      </section>
