...
import styles from "./anxious.module.scss";
...
import art from "Images/anxious.jpg";

/* 3D Rotate 효과 적용 */
const Anxious = ({ history }) => {
    ...
    >
      ...
      <section className={styles["info"]}>
        ...
        <div className={styles["info__desc"]}>
          ...
          >
            세계 속에 보이는 의도적인 질서와 목적으로부터, 원인으로서의 지적인
            설계자는 틀림없이 존재한다.
            <br />
            머릿속에 존재하는 것이 실제로 존재하지 않는다고 해서 느낄 수 없는
            것은 아니다.
          </div>
        </div>
      </section>
